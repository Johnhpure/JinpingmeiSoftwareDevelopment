...
class SubTaskCreateRequest(BaseModel):
    ...
    category: str = Field("", description="任务类别: product/ui_design/frontend/backend/database/devops/general")
    auto_assign: bool = Field(False, description="是否根据 category 自动匹配 Agent")
